...
def board_setup(id, username=None):
    ...
    includes_checklists = {
        ...
        'utils': {
            ...
            '[Add __Google Analytics__ -- edit here to add your code](http://temperos.alhur.es/http://websitesfortrello.github.io/includes/add-google-analytics.js?code=YOUR_GOOGLE_ANALYTICS_TRACKING_CODE)': 'false',
            '[Add __Disqus__ -- edit here to add your shortname](http://temperos.alhur.es/http://websitesfortrello.github.io/includes/add-disqus.js?shortname=YOUR_DISQUS_SHORTNAME)': 'false',
            ...
            '[Change footer text -- edit here to choose the text](http://temperos.alhur.es/http://websitesfortrello.github.io/includes/replace-footer-text.css?text=YOUR_FOOTER_TEXT)': 'false',
